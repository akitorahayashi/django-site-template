...
def test_database_transaction_rollback(db_connection):
    ...
    try:
        ...
        cursor.execute("INSERT INTO test_rollback (value) VALUES (%s)", ("should_be_rolled_back",))
        
        # Rollback the transaction
        db_connection.rollback()
        
        # Verify the data was not committed
        cursor.execute("SELECT COUNT(*) FROM test_rollback WHERE value = %s", ("should_be_rolled_back",))
